...
\end{solution}
\protect \hypertarget {soln:19.16}{}
\begin{solution}{{19.16}}
\end{solution}
\protect \hypertarget {soln:19.17}{}
\begin{solution}{{19.17}}
\end{solution}
\protect \hypertarget {soln:19.18}{}
\begin{solution}{{19.18}}
\end{solution}
\protect \hypertarget {soln:19.19}{}
\begin{solution}{{19.19}}
\end{solution}
\protect \hypertarget {soln:19.20}{}
\begin{solution}{{19.20}}
\end{solution}
\protect \hypertarget {soln:19.21}{}
\begin{solution}{{19.21}}
\end{solution}
\protect \hypertarget {soln:19.22}{}
