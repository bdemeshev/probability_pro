...
\begin{solution}{{6.14}}
\end{solution}
\protect \hypertarget {soln:6.15}{}
\begin{solution}{{6.15}}
\end{solution}
\protect \hypertarget {soln:6.16}{}
\begin{solution}{{6.16}}
\end{solution}
\protect \hypertarget {soln:6.17}{}
\begin{solution}{{6.17}}
\end{solution}
\protect \hypertarget {soln:6.18}{}
\begin{solution}{{6.18}}
\end{solution}
\protect \hypertarget {soln:6.19}{}
\begin{solution}{{6.19}}
\end{solution}
\protect \hypertarget {soln:6.20}{}
\begin{solution}{{6.20}}
\end{solution}
\protect \hypertarget {soln:6.21}{}
\begin{solution}{{6.21}}
\end{solution}
\protect \hypertarget {soln:6.22}{}
\begin{solution}{{6.22}}
\end{solution}
\protect \hypertarget {soln:6.23}{}
\begin{solution}{{6.23}}
\end{solution}
\protect \hypertarget {soln:6.24}{}
\begin{solution}{{6.24}}
\end{solution}
...
\end{solution}
\protect \hypertarget {soln:12.13}{}
\begin{solution}{{12.13}}
\end{solution}
\protect \hypertarget {soln:12.14}{}
\begin{solution}{{12.14}}
\end{solution}
\protect \hypertarget {soln:12.15}{}
\begin{solution}{{12.15}}
\end{solution}
\protect \hypertarget {soln:12.16}{}
\begin{solution}{{12.16}}
\end{solution}
\protect \hypertarget {soln:12.17}{}
...
\end{solution}
\protect \hypertarget {soln:18.15}{}
\begin{solution}{{18.15}}
\end{solution}
\protect \hypertarget {soln:18.16}{}
\begin{solution}{{18.16}}
\end{solution}
\protect \hypertarget {soln:18.17}{}
\begin{solution}{{18.17}}
\end{solution}
\protect \hypertarget {soln:18.18}{}
\begin{solution}{{18.18}}
\end{solution}
\protect \hypertarget {soln:18.19}{}
\begin{solution}{{18.19}}
\end{solution}
\protect \hypertarget {soln:18.20}{}
\begin{solution}{{18.20}}
\end{solution}
\protect \hypertarget {soln:18.21}{}
\begin{solution}{{18.21}}
\end{solution}
\protect \hypertarget {soln:18.22}{}
...
\end{solution}
\protect \hypertarget {soln:19.15}{}
