...
сначала пробует самую левую яблоню в каждом ряду, затем — вторую в каждом ряду и так далее. 
...
Найдите производящие вероятности функции для величин $X_1$, $X_1+X_2$ и $X_1+X_2+X_3$.
