...
\begin{problem}
Случайная величина $X$ имеет нормальное распределение $\cN(\mu; \sigma^2)$.

Найдите точки перегиба функции плотности $f(x)$.
  \begin{sol}
    $\mu \pm \sigma$;
\end{sol}
\end{problem}
...
\begin{enumerate}
  ...
  \item Докажите, что для любой (не обязательно нормальной) величины выполнено неравенство Чернова,
  \[
