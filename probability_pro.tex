...
\begin{enumerate}
  ...
  \item $\binom{5}{0}^2 + \binom{5}{1}^2 + \binom{5}{2}^2 + \binom{5}{3}^2 + \binom{5}{4}^2 = \binom{10}{4}$
\end{enumerate}
\end{eng}
...
\begin{enumerate}[label={(\arabic*)}]
  ...
  \item $(C_{5}^{0})^2 + (C_{5}^{1})^2 + (C_{5}^{2})^2 + (C_{5}^{3})^2 + (C_{5}^{4})^2 = C_{10}^{4}$
\end{enumerate}

\begin{enumerate}
 \item Докажите каждое равенство словами, не вычисляя явно левую и правую части.
\item Обобщите каждое равенство, добавив туда $n$, $k$ и суммы.
\item Докажите каждое полученное равенство алгебраически.
\end{enumerate}
