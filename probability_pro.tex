...
Во время суда одним из многих доводов обвинения стал аргумент о подозрительно высоком выпадении медицинских инцидентов на смены Люсии де Берк. 

Люсиа работала в трёх клиниках: JCH (Juliana Children's Hospital), RCH-41 (Red Cross Hospital) и RCH-42.
...
а число инцидентов во время смен де Берк — случайными величинами. 
Обозначим эти случайные величины $X_1$, $X_2$, $X_3$, соответственно.
...
Во-первых, Гилл предположил, что наблюдения между госпиталями нельзя считать независимыми,
поэтому стоит агрегировать их и рассматривать только сумму $X = X_1 + X_2 + X_3$.
Во-вторых, стоит предположить естественную вариативность числа инцидентов между медсёстрами. 
А именно, предположим, что у каждой медсестры есть индивидуальная интенсивность инцидентов, которая имеет экспоненциальное распределение. 
Обозначим интенсивность инцидентов за смену де Берк буквой $R$, $R \sim \dExpo(\lambda)$.
При фиксированной интенсивности $R$ фактическое число инцидентов $X$ имеет пуассоновское распределение,
с ожиданием равным произведению интенсивности и числа смен, $(X \mid R) \sim \dPois(201 \cdot R)$.
