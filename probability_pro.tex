...
Это задачки к семинарам исследовательского потока факультета экономики вшэ. 
При везении подсказку, ответ или решение можно найти, кликнув по номеру задачи. 
Свежая версия доступна по ссылке \url{https://github.com/bdemeshev/probability_pro}.
Красивые и сложные олимпиадные задачи по вероятностям можно найти на \url{https://github.com/bdemeshev/probability_dna},
а подборку прошлых экзаменов — на \url{https://github.com/bdemeshev/probability_hse_exams}.
...
Рассмотрим две тройки случайных величин, тройку $X_1 = \tan(\pi U/2)$, $Y_1= \tan(\pi U/2)$, $Z_1 = - 2\tan(\pi U/2)$, и тройку $X_2=\tan(\pi U/2)$, $Y_2 = \tan(\pi (1-U)/2)$, $Z_2=-2\tan(\pi \abs{2U-1}/2)$.
