...
Про метод центра масс в геометрии можно прочитать \cite{rike2007mass}.
...
так как невыданными останутся $(b - 1)$ блок, и в каком-то из блоков длины $x$ хвоста окажется две меченых карты.
...
\begin{leftbar}
  Трюк Фейнмана \cite{burg2024feynman} для нахождения интеграла $I$:
  \begin{itemize}
